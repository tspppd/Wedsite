          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card hover>
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 dark:text-gray-100">Drag & Drop</h3>
            ...
            <Card hover>
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 dark:text-gray-100">เทมเพลตสวยๆ</h3>
                <p className="text-gray-600 dark:text-gray-300">
            ...
            <Card hover>
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 dark:text-gray-100">แชร์ง่าย</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <Card key={template.id} hover className="overflow-hidden">
                ...
                >
                  <div className="text-center text-white">
                    ...
                    <p className={`text-2xl font-prompt `} style={{ fontFamily: template.font, color : template.colors.primary }}>
                      {template.name}
                    </p>
                  </div>
                </div>
                <CardContent className="p-6">
                  <h2 className="text-xl font-semibold mb-2 dark:text-gray-100">{template.name}</h2>
              ...
              <Card key={index}>
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="text-lg font-semibold dark:text-gray-100">{section.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {techStack.map((tech, index) => (
              <div key={index} className="text-center p-4 bg-gray-800 dark:bg-gray-900 rounded-xl">
                <h4 className="font-semibold mb-1">{tech.name}</h4>
                <p className="text-sm text-gray-400 dark:text-gray-500">{tech.description}</p>
              </div>
            ))}
          </div>
        </div>
